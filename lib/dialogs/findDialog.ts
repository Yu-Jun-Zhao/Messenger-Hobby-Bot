...
import { createCards } from "../helpers/cardHelper";
...
export class FindVideoDialog extends CancelAndHelpDialog {
  ...
  async apiStep(stepContext: WaterfallStepContext): Promise<DialogTurnResult> {
    ...
    const attachmentsCards: Attachment[] = createCards(youtubeApiRes, "hero");
    // Messenger not supporting other type of cards
    // decide what to make
